...
export const findStuckJobs = defineTool({
  ...
  description:
    "Incident lane — jobs piling up: the live backlog. Surfaces Dataverse async jobs (system jobs) sitting in waiting or in-progress states beyond an age threshold: counts, groups by job name + operation type with status breakdowns, and the oldest individual stuck jobs. Postponed jobs (postponeuntil in the future) are reported separately as scheduled.",
  inputSchema,
